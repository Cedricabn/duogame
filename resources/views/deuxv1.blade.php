...
(function(){
  const THEMES = [
    {
      key:"leger", label:"Léger", tagClass:"cat-leger", color:"var(--gold-dim)",
      questions:[
        "Quel est le moment où tu t'es senti(e) le plus vu(e) et compris(e) par moi ?",
        "Si tu devais résumer ce que je t'apporte que personne d'autre ne t'a apporté, ce serait quoi ?",
        "Quelle version de toi je connais, que presque personne d'autre ne voit ?",
        "Qu'est-ce que tu as arrêté de faire ou de cacher depuis qu'on est ensemble ?",
        "Quel est le rêve que tu n'osais pas dire à voix haute avant de me rencontrer ?",
        "Si tu devais choisir un souvenir de nous à garder pour toujours, et un seul, lequel ?",
        "Qu'est-ce que tu espères qu'on dira de nous, dans vingt ans ?",
        "Quelle partie de toi j'ai aidé à guérir ou à apaiser ?",
        "Qu'est-ce que je fais, sans m'en rendre compte, qui te prouve que je tiens à toi ?",
        "Quel est le plus grand risque affectif que tu aies pris pour être avec moi ?",
        "Qu'est-ce qui te fait dire, certains jours, que tu as fait le bon choix en restant ?",
        "Quelle qualité chez moi t'a le plus surpris(e), une fois que tu as vraiment appris à me connaître ?",
        "Si notre histoire devait avoir un titre honnête aujourd'hui, ce serait lequel ?",
        "Quel est le compliment le plus sincère que tu me ferais si tu savais que je ne pourrais jamais douter de toi ?"
      ]
    },
    {
      key:"profond", label:"Profond", tagClass:"cat-profond", color:"var(--rose-dim)",
      questions:[
        "Quelle est la vérité sur nous que tu as le plus de mal à dire à voix haute ?",
        "Qu'est-ce que tu me pardonnes encore difficilement, même si tu dis que c'est réglé ?",
        "Y a-t-il une part de toi que tu me caches par peur que je m'en aille ?",
        "Qu'est-ce que tu ferais différemment si on recommençait notre histoire depuis le début ?",
        "Quelle est la chose que tu attends de moi depuis longtemps, sans jamais l'avoir demandée clairement ?",
        "Est-ce qu'il y a quelqu'un ou quelque chose du passé que tu n'as pas totalement laissé partir ?",
        "Qu'est-ce que tu trouves le plus difficile à me dire quand tu es en colère contre moi ?",
        "Quelle est la première chose que tu as remarquée chez moi qui t'a donné envie d'aller plus loin ?",
        "Qu'est-ce qui te fait te sentir le plus seul(e), même quand on est ensemble ?",
        "Quelle qualité te manque le plus chez toi, et est-ce que je t'aide à la développer ?",
        "Qu'est-ce que tu attends de moi dans les silences, quand tu n'as pas envie de parler ?",
        "Quelle est la dernière fois où tu as eu peur de me décevoir ?",
        "Qu'est-ce que tu voudrais que je fasse différemment quand on se dispute ?",
        "Y a-t-il une promesse qu'on s'est faite et que tu penses qu'on ne tient pas assez ?",
        "Qu'est-ce qui te donne le plus confiance en notre avenir, malgré les doutes ?",
        "Quelle est la chose que tu voudrais entendre de ma bouche, mais que je ne dis jamais ?",
        "Qu'est-ce que tu ressens quand tu me vois heureux(se) sans toi ?",
        "Quelle habitude à moi te demande le plus de patience ?",
        "Est-ce qu'il y a une part de toi que tu montres seulement à moi ?",
        "Qu'est-ce qui t'a le plus fait grandir depuis qu'on est en couple ?",
        "Quelle est la chose la plus vulnérable que tu m'aies jamais confiée ?",
        "Qu'est-ce que tu redoutes le plus dans une conversation difficile avec moi ?",
        "Quelle décision qu'on a prise ensemble remettrais-tu en question aujourd'hui ?",
        "Qu'est-ce que tu penses que je ne sais pas encore sur ta façon d'aimer ?"
      ]
    },
    {
      key:"intime", label:"Intime", tagClass:"cat-intime", color:"#B49BFA",
      questions:[
        "Y a-t-il un moment où tu t'es senti(e) rejeté(e) ou pas assez désiré(e) par moi ?",
        "Qu'est-ce que tu n'oses pas me demander au lit par peur de ma réaction ?",
        "Quel est le compliment physique que tu voudrais entendre plus souvent ?",
        "Qu'est-ce qui te met le plus à l'aise pour te laisser aller avec moi ?",
        "Quel moment de complicité silencieuse entre nous t'a le plus marqué(e) ?",
        "Qu'est-ce que tu aimerais qu'on prenne plus de temps pour faire, tous les deux ?",
        "Quelle marque d'affection physique te manque le plus au quotidien ?",
        "Qu'est-ce qui te fait rougir quand tu y repenses, entre nous ?",
        "Quel rituel du soir ou du matin aimerais-tu qu'on instaure ensemble ?",
        "Qu'est-ce qui te donne le sentiment d'être vraiment choisi(e) par moi ?",
        "Quelle attention physique toute simple te touche le plus (un regard, une main, un souffle) ?",
        "Qu'est-ce que tu aimerais essayer pour raviver notre complicité ?",
        "Quel est le moment de la journée où tu as le plus envie qu'on soit proches ?",
        "Qu'est-ce que tu ressens quand je prends soin de toi physiquement, sans rien attendre en retour ?",
        "Quelle petite habitude intime aimerais-tu qu'on garde toute la vie ?",
        "Qu'est-ce qui te ferait te sentir encore plus en confiance pour explorer avec moi ?"
      ]
    },
    {
      key:"souvenirs", label:"Souvenirs", tagClass:"cat-profond", color:"var(--rose-dim)",
      questions:[
        "Quel a été le moment le plus proche où on a failli se perdre, sans jamais vraiment le dire ?",
        "Quelle période de notre histoire a été la plus dure à traverser, et qu'est-ce qui nous a fait tenir ?",
        "Quel est le premier souvenir de nous qui te fait encore sourire aujourd'hui ?",
        "Quelle soirée ordinaire garde une place à part dans ta mémoire ?",
        "Quel a été le moment où tu as senti qu'on formait vraiment une équipe ?",
        "Quelle phrase que je t'ai dite un jour t'a marqué(e) pour longtemps ?",
        "Quel souvenir aimerais-tu qu'on recrée exactement pareil ?",
        "Quelle a été la surprise la plus mémorable qu'on s'est faite ?",
        "Quel moment gênant vécu ensemble te fait encore rire ?",
        "Quelle étape qu'on a franchie ensemble t'a rendu(e) le plus fier(fière) de nous ?"
      ]
    },
    {
      key:"avenir", label:"Avenir", tagClass:"cat-leger", color:"var(--gold-dim)",
      questions:[
        "Quelle est la condition, jamais posée à voix haute, sans laquelle tu ne resterais pas ?",
        "Qu'est-ce qui te ferait vraiment envisager de partir, si les choses tournaient mal ?",
        "Si on devait se marier ou s'engager davantage, qu'est-ce qui te retient encore aujourd'hui ?",
        "Quel petit rituel voudrais-tu qu'on construise pour les années à venir ?",
        "Comment imagines-tu qu'on gère les moments difficiles dans dix ans ?",
        "Quel voyage rêves-tu qu'on fasse ensemble avant tout le reste ?",
        "Qu'est-ce qui te ferait dire qu'on a bien vieilli ensemble ?",
        "Quelle habitude actuelle voudrais-tu qu'on garde pour toujours ?",
        "Comment vois-tu notre équilibre entre vie de couple et projets personnels, plus tard ?",
        "Quel serait, pour toi, le signe qu'on a construit quelque chose de solide ?",
        "Qu'est-ce que tu voudrais qu'on apprenne à faire ensemble cette année ?"
      ]
    },
    {
      key:"famille", label:"Famille & valeurs", tagClass:"cat-profond", color:"var(--rose-dim)",
      questions:[
        "Qu'est-ce que tu n'as jamais dit à ta famille sur nous, et pourquoi ?",
        "Quelle blessure familiale continue d'influencer la façon dont tu m'aimes, même sans que tu le veuilles ?",
        "Quelle tradition familiale voudrais-tu qu'on transmette à notre façon ?",
        "Comment aimerais-tu qu'on gère les désaccords avec nos familles respectives ?",
        "Qu'est-ce que tu espères que nos proches retiennent de nous en tant que couple ?",
        "Quelle qualité de tes parents espères-tu avoir hérité pour notre relation ?",
        "Comment imagines-tu les fêtes de fin d'année dans quelques années ?",
        "Qu'est-ce que le mot « équipe » signifie pour toi dans une famille ?",
        "Quelle place voudrais-tu que nos amis proches occupent dans notre vie à deux ?"
      ]
    },
    {
      key:"humour", label:"Jeu & humour", tagClass:"cat-leger", color:"var(--gold-dim)",
      questions:[
        "Si on tournait un film sur nous, quel en serait le titre ?",
        "Quel super-pouvoir voudrais-tu qu'on ait à deux, et pour en faire quoi ?",
        "Quelle est la chose la plus ridicule que tu aies faite pour me faire rire ?",
        "Si tu devais me surnommer autrement à partir d'aujourd'hui, ce serait quoi ?",
        "Quel est le combat le plus absurde qu'on ait eu ?",
        "Quel serait notre pire scénario de rendez-vous catastrophe, version comédie ?",
        "Si on devait se faire tatouer un mot en lien avec nous, lequel ce serait ?"
      ]
    }
  ];
   ...
   */
   async function patchAnswer(questionIdx, key, val){
    ...
    const s = await res.json();
    return s.answers || {}; // <- s.answers existe bien puisque toArray() l'inclut
  }
  ...
  async function syncFromRemote(){
    ...
    try{
      ...
      if(!answersChanged && !gameChanged && !tttChanged) return;
  ...
  function renderSlot(letter, key, rec, bothDone){
    ...
    if(!mine.trim() && isMine && existingTa){
      return;
    }
    if(mine.trim() && isMine && isEditing && existingTa){
      return;
    }
